...
function NN = BPNNet(X,Y,T,K,eta,r)
[rows,cols] = size(X);
...
%     approxDelta1 = ((y-tanh(W2Plus'*x1))^2 - (y-tanh(W2Minus'*x1))^2) /(2*epsilon);
%     approxDelta1
%     Delta1(inx)
%     abs(approxDelta1- Delta1(inx))
...
%     approxDelta2 = ((y-tanh(W2'*[1;tanh(W1Plus'*x0)]))^2 - (y-tanh(W2'*[1;tanh(W1Minus'*x0)]))^2) /(2*epsilon);
